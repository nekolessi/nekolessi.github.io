...
4. Edit `PROFILE_LOCATION` and the view counter constants (`VIEW_COUNTER_BASE`, `VIEW_COUNTER_NAMESPACE`, `VIEW_COUNTER_KEY`) if you want to customize the top-right hero stats.
