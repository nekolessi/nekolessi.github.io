...
export const PROFILE = {
  ...
  bioBlocks: [
    ...
    "I SPEND MOST OF MY TIME WATCHING VTUBERS, DRAWING RANDOM THINGS, AND DRIFTING OFF INTO MY OWN WORLD FOR HOURS AT A TIME...",
    "I'M SHY, AWKWARD, DUMB, LEWD, AND MAY OR MAY NOT REQUIRE OCCASIONAL HEADPATS FOR MAINTENANCE...",
  ],
  links: [
    /**{
      label: "Oshi Card",
