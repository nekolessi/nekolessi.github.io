...
export const PROFILE = {
  ...
  bioBlocks: [
    ...
    "I SPEND MOST OF MY TIME WATCHING VTUBERS, DRAWING CUTE THINGS, AND GETTING LOST IN MY OWN LITTLE WORLD FOR HOURS AT A TIME...",
    "I'M SHY, AWKWARD, DUMB, LEWD, AND COULD PROBABLY BE FIXED WITH ENOUGH HEADPATS...",
  ],
  links: [
    /**{
      label: "Oshi Card",
